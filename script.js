document.addEventListener('alpine:init', () => {
  Alpine.data('commentsApp', () => ({
    ...
    set setDeleteCommentData(data) {
      this.deleteCommentData.parrentCommentId = data?.parrentCommentId ?? false
      this.deleteCommentData.id = data.id
    },
